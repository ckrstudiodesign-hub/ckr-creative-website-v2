    ...
    <section className="w-full bg-brand-white px-5 py-8 md:px-10 md:py-12 xl:px-[56px] overflow-hidden">
      <div className="w-full max-w-[1300px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-5 xl:gap-6 items-start justify-items-center">
          {/* LEFT — LinkedIn (phone hidden on mobile, CTA kept below the IG phone) */}
          <motion.div
          ...
          {/* RIGHT — X / Twitter (phone hidden on mobile, CTA kept below the IG phone) */}
          <motion.div
            initial={{ opacity: 0, y: 24, rotate: 1 }}
            whileInView={{ opacity: 1, y: 0, rotate: 0 }}
            viewport={{ once: true, margin: '-80px' }}
        ...
        {/* Mobile-only: all 3 platform CTAs as a row (LinkedIn + X phones hidden above) */}
        <div className="lg:hidden mt-6 flex flex-wrap items-center justify-center gap-2.5">
          <a
            href={LINKEDIN_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full bg-[#0a66c2] px-4 py-2.5 text-white text-[12px] font-semibold tracking-wide shadow-[0_10px_30px_rgba(10,102,194,0.35)]"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.063 2.063 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
            </svg>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full bg-black px-4 py-2.5 text-white text-[12px] font-semibold tracking-wide shadow-[0_10px_30px_rgba(0,0,0,0.35)]"
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
